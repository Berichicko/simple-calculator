...
public class Main {
    public static void main(String[] args) {
        try {
            ...
            System.out.println("Сумма двух чисел: " + numberFirst + " + " + numberSecond + " = " + sum.calculation());
            System.out.println("Произведение двух чисел: " + numberFirst + " * " + numberSecond + " = " + multiplying.calculation());
        } catch (Exception e) {
